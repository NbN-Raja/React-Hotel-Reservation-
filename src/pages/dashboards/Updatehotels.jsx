...
export default function Updatehotels() {
    ...
    //    Get Hotels
const baseURL =
`http://nbn-hotel-reservation-backend.clouds.nepalicloud.com/api/hotels/${params.id}`;
...
//   const [setHotels] = React.useState(null);
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const session = await Updatehotels({
      ...
      <section className="w-full h-screen  flex justify-between">
        ...
        <div className="w-full h-full bg-blue-gray-100 overflow-x-auto">
          ...
          <div className="text-5xl">
            <h1 className="font-dashboard mt-10 text-black"> Update  Your Hotels</h1>
          </div>
